...
#SBATCH --job-name="sam-alignment-trial1"
#SBATCH --output=sam-alignment-trial1.out
...
#set directory
cd /projects/rpci/joyceohm/Emily/RRBS-pipeline/Test

mkdir 1-Trimmed-Test

find -name "*R1_001.fastq.gz" | cut -d "_" -f1 | 
parallel -j 1 trim_galore \
--paired -o ../1-Trimmed-Test {}*R1_001.fastq.gz {}*R3_001.fastq.gz
