...
N=4
(
for read1 in RQ025150-Ohm/*/*R1_001.fastq.gz; do ((i=i%N)); ((i++==0)) && wait read2=$(echo $read1| sed 's/R1_001.fastq.gz/R3_001.fastq.gz/'); trim_galore --paired -a AGATCGGAAGAGC -a2 AAATCAAAAAAAC $read1 $read2 -o Trimmed & done
)
...
curl -o Scripts/trimRRBSdiversity.py https://raw.githubusercontent.com/nugentechnologies/NuMetRRBS/master/trimRRBSdiversityAdaptCustomers.py

## run NuGen diversity trimming script
for read1 in Trimmed/*R1_001_val_1.fq.gz; do read2=$(echo $read1| sed 's/R1_001_val_1.fq.gz/R3_001_val_2.fq.gz/'); python Scripts/trimRRBSdiversity.py -1 $read1 -2 $read2 -o Trimmed & done
...
module load bimark
N=4
(for read1 in Trimmed/*R1_001_val_1.fq_trimmed.fq.gz; do ((i=i%N)); ((i++==0)) && wait read2=$(echo $read1| sed 's/R1_001_val_1.fq_trimmed.fq.gz/R3_001_val_2.fq_trimmed.fq.gz/'); bismark --bowtie2 #location/bismark/genome 
-1 $read1 -2 $read2 -o Aligned & done)
...
## strip bismark to sam for NuDup
### pull script from NuGen
curl -o Scripts strip_bismark_sam.sh https://raw.githubusercontent.com/nugentechnologies/NuMetRRBS/master/strip_bismark_sam.sh
### run script 


## pull NuDup script from NuGen
### May 13th- remember to document the details of how Nudup runs on paired-end reads in the ReadMe for this git 
curl -o Scripts nudup.py https://raw.githubusercontent.com/tecangenomics/nudup/master/nudup.py
### run script 

## delete files
find Scripts/strip_bismark_sam.sh -delete
